...
(function ($) {
    ...
    $.fn.tdcss = function (options) {
        ...
        function highlightSyntax() {
            ...
            try {
                loadScriptSynchronously("/test/libs/tdcss/src/vendors/prism/prism.js", "Prism", function () {
        ...
        function diff() {
            try {
                loadScriptSynchronously("/test/libs/tdcss/src/vendors/html2canvas.js", "html2canvas", function () {
                    loadScriptSynchronously("/test/libs/tdcss/src/resemble-modified.js", "resemble", function () {
