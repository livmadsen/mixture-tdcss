describe("jasmine.Fixtures", function() {
  ...
  describe("default initial config values", function() {
    ...
    it("should set '/test/spec/javascripts/fixtures' as the default fixtures path", function() {
      expect(jasmine.getFixtures().fixturesPath).toEqual('/test/spec/javascripts/fixtures')
    })
  })
...
describe("jasmine.StyleFixtures", function() {
  ...
  describe("default initial config values", function() {
    it("should set '/test/spec/javascripts/fixtures' as the default style fixtures path", function() {
      expect(jasmine.getStyleFixtures().fixturesPath).toEqual('/test/spec/javascripts/fixtures')
    })
  })
...
describe("jasmine.StyleFixtures using real AJAX call", function() {
  ...
  beforeEach(function() {
    ...
    jasmine.getStyleFixtures().fixturesPath = '/test/spec/fixtures'
  })
...
describe("jasmine.JSONFixtures", function() {
  ...
  describe("default initial config values", function() {
    it("should set '/test/spec/javascripts/fixtures' as the default style fixtures path", function() {
      expect(jasmine.getJSONFixtures().fixturesPath).toEqual('/test/spec/javascripts/fixtures')
    })
  })
